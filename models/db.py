...
db.define_table('kh', Field('nsrsbh'),Field('dwmc'),Field('rq'),Field('khyh'),Field('yhzh'),Field('lxdz'),Field('dzxx'),Field('cz'),Field('username'))
db.define_table('tbbzj', Field('dwmc'),Field('bsbh'),Field('bzjlx'),Field('je'),Field('rq'),Field('username'),Field('ly'),Field('lyId'))
