...
db.define_table('gmbs', Field('dwmc'),Field('nsrsbh'),Field('lxdz'),Field('dh'),Field('khyh'),Field('yhzh'),Field('zzsdwmc'),Field('lxr'),Field('sj'),Field('lxrdh'),Field('lxrdz'),Field('dzxx'),Field('cz'),Field('bsbh'),Field('je'),Field('rq'),Field('username'),Field('ly'))
