...
db.define_table('Project',Field('Assistant'),Field('BuyerId'),Field('CreationDate'),Field('EmployeeId'),Field('IsDelete'),Field('ManagementStyleId'),Field('Note'),Field('ProjectCodeId'),Field('ProjectName'),Field('ProjectSourceId'),Field('ProjectTypeId'),Field('ProtocolCodeId'),Field('SourcesOfFundingId'),Field('StateId'))
