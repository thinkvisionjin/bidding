...
{ text: '进口论证', aggregates: ['sum'],aggregatesrenderer: function (aggregates) {return aggregates['sum'];}, datafield: 'jklz', width: '10%',cellsalign: 'center', align: 'center',hidden:false },
{ text: '咨询', aggregates: ['sum'],aggregatesrenderer: function (aggregates) {return aggregates['sum'];}, datafield: 'zx', width: '10%',cellsalign: 'center', align: 'center',hidden:false },
