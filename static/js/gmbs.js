...
function addselectfieldwindows() {
	$(document.body)
			.append(
					'<div id="popupWindow" ><div>字段选择</div><div style="overflow: hidden;"><div  id="zdlistbox"></div></div></div>');
...
function deletegmbs(id) {
	/*
	 * var selectedrowindex = $("#gmbs-grid").jqxGrid('getrowid',
	 * selectedrowindex); alert(selectedrowindex+" "+id);
							...
							.jqxGrid(
									{
										...
										columns : [
												...
												},
												{
													...
													cellsrenderer : function(
															...
															defaultvalue,
															column, rowdata) {
														var a = '<a style="margin-right: 5px;padding-top:3px;height:15px;text-decoration:none;" class="MdyBtn" onclick="printgmbs('
																+ rowdata.Id
																+ ')">打印</a>';

														var b = '<a style="margin-right: 5px;padding-top:3px;height:15px;text-decoration:none;" class="MdyBtn" onclick="modifygmbs('
																+ rowdata.Id
																+ ')">修改</a>';

														var c = '<a style="margin-right: 5px;;padding-top:3px;height:15px;text-decoration:none;" class="MdyBtn" onclick="deletegmbs('
																+ rowdata.Id
																+ ')">删除</a>';
														var d = '<a style="margin-right: 5px;;padding-top:3px;height:15px;text-decoration:none;" class="MdyBtn" onclick="detailgmbs('
																+ rowdata.Id
																+ ')">详细</a>';
										...
										rendertoolbar : function(toolbar) {
											...
											container
													.append('<input id="gmbsadd" type="button" value="新增" />');
											$("#gmbsadd").jqxButton({
												template : 'success'
											});
											container
													.append('<input id="selectfiled" style="float: right" type="button" value="设置" />');
