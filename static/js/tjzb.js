					...
					$("#tjzb_grid2")
							.jqxGrid(
									{				
										...
										enablebrowserselection: true,
										columns : [{ text: '采购方式',aggregatesrenderer: function (aggregates) {return '合计';}, pinned: true, datafield: 'cgfs', width: '10%',cellsalign: 'center', align: 'center' },
{ text: '机电', aggregates: ['sum'],aggregatesrenderer: function (aggregates) {return aggregates['sum'];}, datafield: 'jd', width: '10%',cellsalign: 'center', align: 'center' },
{ text: '政府采购项目(线下)', aggregates: ['sum'],aggregatesrenderer: function (aggregates) {return aggregates['sum'];}, datafield: 'zf', width: '10%',cellsalign: 'center', align: 'center' },
{ text: '国债技改项目', aggregates: ['sum'],aggregatesrenderer: function (aggregates) {return aggregates['sum'];}, datafield: 'gj', width: '10%',cellsalign: 'center', align: 'center' },
{ text: '同属政府采购、国债技改项目', aggregates: ['sum'],aggregatesrenderer: function (aggregates) {return aggregates['sum'];}, datafield: 'ts', width: '10%',cellsalign: 'center', align: 'center' },
...
{ text: '政府采购项目(二期)', aggregates: ['sum'],aggregatesrenderer: function (aggregates) {return aggregates['sum'];}, datafield: 'zfe', width: '10%',cellsalign: 'center', align: 'center' },
