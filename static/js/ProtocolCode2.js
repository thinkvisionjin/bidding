...
$(document).ready(function () {
          ...
          //********INIT_INPUT_FIELDS START******************//
			...
			$("#TypeId_SEARCH").addClass('jqx-input')
			$("#TypeId_SEARCH").width(150)
			$("#TypeId_SEARCH").height(23)
           ...
           //********COLUMNS_CONTENT  END******************//
            $("#jqxgrid").jqxGrid(
            {
                ...
                rendertoolbar: function (toolbar) {
                    ...
                    var searchArea = $("<div id='searchArea'>\
    	<table id='Table_SEARCH' width='100%'>\
    			<tr> \
	    			<td>序       号: </td> \
	    			<td> <input type='text' id='Id_SEARCH'/> </td> \
	    			<td>协议编号:</td> \
	    			<td><input type='text' id='ProtocolNumber_SEARCH'/> </td> \
    			</tr>\
    			<tr> \
    				<td>类型编号:</td> \
    				<td> <input type='text' id='TypeId_SEARCH'/> </td> \
    				<td>员工编号:</td> \
    				<td><input type='text' id='EmployeeId_SEARCH'/></td>\
    			</tr>\
    			<tr> \
    				<td>创建日期:</td> \
    				<td> <input type='text' id='CreationTime_SEARCH'/> </td> \
    				<td>是否已删除:</td> \
    				<td><input type='text' id='IsDelete_SEARCH'/></td> \
    			</tr>\
    		</table>\
    	</div>")
            ...
            $("#Save_EDIT").click(function () {
                if (editrow >= 0) {
                    ...
                    {Id:$("#Id").val(),ProtocolNumber:$("#ProtocolNumber_EDIT").val(),TypeId:$("#TypeId_EDIT").val(),EmployeeId:$("#EmployeeId_EDIT").val(),CreationTime:$("#CreationTime_EDIT").val(),IsDelete:$("#IsDelete_EDIT").val()};
            ...
            $("#Save_ADD").click(function () {
              ...
              //******** ADD_ROW_CONTENT_SAVE START*****************//
               {ProtocolNumber:$("#ProtocolNumber_ADD").val(),TypeId:$("#TypeId_ADD").val(),EmployeeId:$("#EmployeeId_ADD").val()	,CreationTime:$("#CreationTime_ADD").val(),IsDelete:$("#IsDelete_ADD").val()};
              //******** ADD_ROW_CONTENT_SAVE START*****************//
               var datarow = row;
