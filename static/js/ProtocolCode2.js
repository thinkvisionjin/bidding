...
$(document).ready(function () {
          ...
          //********INIT_INPUT_FIELDS END******************//
            ...
            //********COLUMNS_CONTENT START******************//
            	[{"datafield":"Id","text":"\u5e8f\u53f7","width":200},{"datafield":"ProtocolNumber","text":"\u534f\u8bae\u7f16\u53f7","width":200},{"datafield":"TypeId","text":"\u7c7b\u578b\u7f16\u53f7","width":200},{"datafield":"EmployeeId","text":"\u5458\u5de5\u7f16\u53f7","width":200},{"datafield":"CreationTime","text":"\u521b\u5efa\u65e5\u671f","width":200},{"datafield":"IsDelete","text":"\u662f\u5426\u5df2\u5220\u9664","width":200}]
           //********COLUMNS_CONTENT  END******************//
            $("#jqxgrid").jqxGrid(
            {
                width: '100%',
                ...
                rendertoolbar: function (toolbar) {
                    ...
                    var exportButton = $("<div style='float: left; margin-left: 5px;'><span style='margin-left: 4px; position: relative; top: 0px;'>导出Excel</span></div>");
            ...
            $("#popupWindow_EDIT").jqxWindow({ width: 250, resizable: false,  isModal: true, autoOpen: false, cancelButton: $("#Cancel"), modalOpacity: 0.01 });
            ...
            $("#Save").click(function () {
                if (editrow >= 0) {
                    ...
                    {Id:$("#Id").val(),ProtocolNumber:$("#ProtocolNumber").val(),TypeId:$("#TypeId").val(),EmployeeId:$("#EmployeeId").val(),CreationTime:$("#CreationTime").val(),IsDelete:$("#IsDelete").val()};
